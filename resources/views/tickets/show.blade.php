<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 py-8 printable-wrapper">
        ...
        <div class="flex justify-center">
            ...
            <div id="ticket-card-stub" class="ticket-card-stub bg-white border-2 border-[#F37032] relative w-full max-w-md flex flex-col justify-between box-border shadow-md">
